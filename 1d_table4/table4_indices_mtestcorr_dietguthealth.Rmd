...
# Extract p-values 
p_c_s_hei_asa24_totalscore <- summary(mod_hei_asa24_totalscore_c)$coefficients[2,4] 
p_m_s_hei_asa24_totalscore <- summary(mod_hei_asa24_totalscore_m)$coefficients[2,4]
...
# Extract p-values 
p_c_s_hei_ffq_totalscore <- summary(mod_hei_ffq_totalscore_c)$coefficients[2,4] 
p_m_s_hei_ffq_totalscore <- summary(mod_hei_ffq_totalscore_m)$coefficients[2,4]
...
# Extract p-values 
p_c_s_dii_asa24_total_score <- summary(mod_dii_asa24_total_score_c)$coefficients[2,4] 
p_m_s_dii_asa24_total_score <- summary(mod_dii_asa24_total_score_m)$coefficients[2,4]
...
# Extract p-values 
p_c_s_dii_ffq_total_score <- summary(mod_dii_ffq_total_score_c)$coefficients[2,4] 
p_m_s_dii_ffq_total_score <- summary(mod_dii_ffq_total_score_m)$coefficients[2,4]
...
c_s_asa_pk_pval_df_t <- data.frame(p_c_s_hei_asa24_totalscore, p_c_s_dii_asa24_total_score)
c_s_ffq_pk_pval_df_t <- data.frame(p_c_s_hei_ffq_totalscore, p_c_s_dii_ffq_total_score)

m_s_asa_pk_pval_df_t <- data.frame(p_m_s_hei_asa24_totalscore, p_m_s_dii_asa24_total_score)
m_s_ffq_pk_pval_df_t <- data.frame(p_m_s_hei_ffq_totalscore, p_m_s_dii_ffq_total_score)
