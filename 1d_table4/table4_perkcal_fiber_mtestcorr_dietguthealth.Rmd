...
c_s_asa_pk_pval_df <- data.frame(p_c_fib)
c_s_ffq_pk_pval_df <- data.frame(p_c_fib_f, p_c_sfib_f)

m_s_asa_pk_pval_df <- data.frame(p_m_fib)
m_s_ffq_pk_pval_df <- data.frame(p_m_fib_f, p_m_sfib_f)
